  ...
  businessHours: {
    ...
    about: "Shree Enterprise is a trusted leader in providing comprehensive fire safety solutions across Bhavnagar and surrounding regions. With years of proven experience, we specialize in designing, installing, and maintaining advanced fire protection systems. Our team of certified professionals is committed to safeguarding lives and property through reliable, high-quality services. We strictly comply with all local and national fire safety regulations, ensuring that every system we deliver meets the highest standards of safety and efficiency.Shree Enterprise is a trusted leader in providing comprehensive fire safety solutions across Bhavnagar and surrounding regions. With years of proven experience, we specialize in designing, installing, and maintaining advanced fire protection systems. Our team of certified professionals is committed to safeguarding lives and property through reliable, high-quality services. We strictly comply with all local and national fire safety regulations, ensuring that every system we deliver meets the highest standards of safety and efficiency."
  };
